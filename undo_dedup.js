...
async function undoDuplicates() {
  ...
  const mappings = [
    { newCode: 'G0318', oldCode: 'G0304', userId: 'f5c626af-d332-46d3-9c8d-63765276abcf' },
    { newCode: 'G0319', oldCode: 'G0303', userId: '81dc538f-2817-43e4-877c-05fdb5806f61' },
  ];
...
undoDuplicates().catch(console.error).finally(() => prisma.$disconnect());
