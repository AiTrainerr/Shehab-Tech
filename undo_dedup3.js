...
async function undoDuplicates3() {
  const projectId = 'cmr3u2h6q002ec4c0kypprpsi';
  
  const mappings = [
    { newCode: 'G0322', oldCode: 'G0311', userId: 'f406a292-5ab2-42ae-996d-85ff9d09d5f9' },
  ];
...
undoDuplicates3().catch(console.error).finally(() => prisma.$disconnect());
