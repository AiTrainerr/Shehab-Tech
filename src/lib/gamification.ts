...
export const LEVELS: LevelInfo[] = [
  { label: "مبتدئ",  labelEn: "Beginner", emoji: "🌱", cssClass: "level-beginner", minCompleted: 0,   maxCompleted: 4,    color: "#8b5cf6" },
  { label: "محترف",  labelEn: "Pro",      emoji: "⚡", cssClass: "level-pro",      minCompleted: 5,   maxCompleted: 14,   color: "#3b82f6" },
  { label: "خبير",   labelEn: "Expert",   emoji: "🔥", cssClass: "level-expert",   minCompleted: 15,  maxCompleted: 29,   color: "#ef4444" },
  { label: "نجم",    labelEn: "Star",     emoji: "⭐", cssClass: "level-star",     minCompleted: 30,  maxCompleted: null, color: "#f59e0b" },
]
...
export function getUserBadges(user: {
  ...
  return [
    ...
    },
    {
      ...
      nameEn: "Top Rated",
      emoji: "🌟",
      description: "احصل على تقييم 4.5+",
      earned: rating >= 4.5,
      color: "#f59e0b",
    },
  ]
